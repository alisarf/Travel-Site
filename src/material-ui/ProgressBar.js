...
const ProgressBar = (props) => {
    ...
    return (
        <div>
            <h6 className= "Black inline Roboto_Condense font-bold tracking-wide" style={{width: '60px'}}>{props.title}:</h6>
            <div className="flex flex-row gap-4 items-center">
                ...
                <div className="inline Roboto_Condense font-bold tracking-wide" style={{minWidth: "40px"}}><h6 className="w-fit ml-auto">{props.value}%</h6></div>
            </div>
        </div>
    )
}
