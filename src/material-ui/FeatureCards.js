...
const FeatureCards = () => {
    ...
    return (
        <section className='my-10'>
            <Typography variant='h5' className='text-center' sx={{ fontWeight: '700'}}>Featured Locations</Typography>
            <h6 className='text-center text-gray-400'>Explore the best locations within the southern region.</h6>
            <div className='my-5'>
                {arr.map(item => (
